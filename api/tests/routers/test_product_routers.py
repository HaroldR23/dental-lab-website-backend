from api.src.routers.product import create_product
from unittest.mock import patch
from fastapi.testclient import TestClient
import pytest
from adapters.src.repositories.sql.sql_product_adapter import SQLProductRepository
from core.src.use_cases.product.create import CreateProduct, CreateProductResponse

def test_create_product_successfully(
        client: TestClient, 
        mock_product_payload :dict
    ):
